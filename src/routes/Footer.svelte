        ...
        <div class="foot_place_1">
            <div>
                <ul class="footer_links">
                    ...
                    <li><a href="/news">Creative Links</a></li>
                    <li><a href="/about">On Development</a></li>
                    <li><a href="http://www.github.com/GregGallant">GitHub</a></li>
                    <li><a target="linkedin" href="http://www.linkedin.com/in/greggallant">Linked-In</a></li>
                    <li><a target="hatecrimeprevention" href="https://www.justice.gov/hatecrimes/spotlight/combating-hate-crimes">Hate Crime Prevention</a></li>
